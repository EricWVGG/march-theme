...
add_action('init', 'create_post_type_featured_projects'); // Add our Case Study Type
add_action('init', 'create_post_type_archi_imaging'); // Add our Case Study Type
add_action('init', 'create_post_type_dev_marketing'); // Add our Case Study Type
