...
$(function() {
  ...
  // TEMP: Case Study hover == Coming Soon
  $('body').on('mouseenter', '#menu-item-175', function() {
    $(this).find('a').html('Coming Soon');
  }).on('mouseleave', '#menu-item-175', function() {
    $(this).find('a').html('Case Studies');
  });
