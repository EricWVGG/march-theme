...
var count=document.createElement('script');count.type='text/javascript';count.async=true;count.src='//hello.myfonts.net/count/28a384';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if(typeof(woffEnabled)=='undefined'){var woffEnabled=true;}
...
suffix="_unhinted";
var fonts=[
  {"fontFamily":"HelveticaNeueLTStd-Lt","url":wfpath+"28A384_0"+suffix+"_0."+webfontType},
  {"fontFamily":"HelveticaNeueLTStd-UltLt","url":wfpath+"28A384_1"+suffix+"_0."+webfontType},
  {"fontFamily":"HelveticaNeueLTStd-Roman","url":wfpath+"28A384_2"+suffix+"_0."+webfontType},
  {"fontFamily":"HelveticaNeueLTStd-Th","url":wfpath+"28A384_3"+suffix+"_0."+webfontType},
  {"fontFamily":"HelveticaNeueLTStd-Md","url":wfpath+"28A384_4"+suffix+"_0."+webfontType}
];var len=fonts.length;document.write("<style>");for(var i=0;i<len;i++){if(webfontType=="svg#wf"){var format="format(\"svg\")";}
